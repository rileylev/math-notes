...
Algebraic geometry \emph{was} the study of systems of polynomial equations, until, in the search for a cohomology theory for {finite} fields ({\footnotesize\url{https://en.wikipedia.org/wiki/Weil_conjectures}}), which you'd normally think of as discrete spaces, algebraic geometers were driven to madness. But, if you look closely, you can still see the polynomial equations, peering out from behind the sheaves and schemes.
